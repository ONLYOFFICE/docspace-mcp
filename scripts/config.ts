...
export const options: Option[] = [
	...
	},
	{
		...
		description: "The base URL of the DocSpace OAuth service.",
		transports: ["sse", "streamable-http"],
		distribution: ["js", "oci"],
		type: "string",
		choices: [],
	...
	{
		env: "DOCSPACE_OAUTH_SCOPES_SUPPORTED",
		header: "",
		title: "OAuth Scopes Supported",
		description: "The list of scopes supported by the OAuth protected resource.",
		transports: ["sse", "streamable-http"],
		distribution: ["js", "oci"],
		type: "string",
		choices: [],
	...
	{
		env: "DOCSPACE_OAUTH_RESOURCE_NAME",
		header: "",
		title: "OAuth Resource Name",
		description: "The name of the OAuth protected resource.",
		transports: ["sse", "streamable-http"],
		distribution: ["js", "oci"],
		type: "string",
		choices: [],
	...
	{
		env: "DOCSPACE_OAUTH_RESOURCE_DOCUMENTATION",
		header: "",
		title: "OAuth Resource Documentation",
		description: "The URL to the documentation for the OAuth protected resource.",
		transports: ["sse", "streamable-http"],
		distribution: ["js", "oci"],
		type: "string",
		choices: [],
	...
	{
		env: "DOCSPACE_OAUTH_REDIRECT_URIS",
		header: "",
		title: "OAuth Redirect URIs",
		description: "The list of redirect URIs for the OAuth client.",
		transports: ["sse", "streamable-http"],
		distribution: ["js", "oci"],
		type: "string",
		choices: [],
	...
	{
		env: "DOCSPACE_OAUTH_CLIENT_NAME",
		header: "",
	...
	{
		env: "DOCSPACE_OAUTH_SCOPES",
		header: "",
		title: "OAuth Scopes",
		description: "The list of scopes requested by the OAuth client.",
		transports: ["sse", "streamable-http"],
		distribution: ["js", "oci"],
		type: "string",
		choices: [],
	...
	{
		env: "DOCSPACE_OAUTH_TOS_URI",
		header: "",
		title: "OAuth ToS URI",
		description: "The URL to the Terms of Service (ToS) for the OAuth client.",
		transports: ["sse", "streamable-http"],
		distribution: ["js", "oci"],
		type: "string",
		choices: [],
	...
	{
		env: "DOCSPACE_OAUTH_POLICY_URI",
		header: "",
		title: "OAuth Policy URI",
		description: "The URL to the Privacy Policy for the OAuth client.",
		transports: ["sse", "streamable-http"],
		distribution: ["js", "oci"],
		type: "string",
		choices: [],
	...
	},
	{
		...
		description: "The base URL of the DocSpace MCP server.",
		transports: ["sse", "streamable-http"],
		distribution: ["js", "oci"],
		type: "string",
		choices: [],
	...
	{
		env: "DOCSPACE_SERVER_CORS_OAUTH_METADATA_ORIGIN",
		header: "",
		title: "Server CORS OAuth Metadata Origin",
		description: "The list of allowed origins to include in the Access-Control-Allow-Origin header for CORS requests to OAuth metadata endpoints.",
		transports: ["sse", "streamable-http"],
		distribution: ["js", "oci"],
		type: "string",
		choices: [],
	...
	{
		env: "DOCSPACE_SERVER_CORS_OAUTH_METADATA_MAX_AGE",
		header: "",
		title: "Server CORS OAuth Metadata Maximum Age",
		description: "The maximum age in milliseconds to include in the Access-Control-Max-Age header for CORS requests to OAuth metadata endpoints.",
		transports: ["sse", "streamable-http"],
		distribution: ["js", "oci"],
		type: "number",
		choices: [],
	...
	{
		env: "DOCSPACE_SERVER_CORS_OAUTH_REGISTER_ORIGIN",
		header: "",
		title: "Server CORS OAuth Register Origin",
		description: "The list of allowed origins to include in the Access-Control-Allow-Origin header for CORS requests to the OAuth client registration endpoint.",
		transports: ["sse", "streamable-http"],
		distribution: ["js", "oci"],
		type: "string",
		choices: [],
	...
	{
		env: "DOCSPACE_SERVER_CORS_OAUTH_REGISTER_MAX_AGE",
		header: "",
		title: "Server CORS OAuth Register Maximum Age",
		description: "The maximum age in milliseconds to include in the Access-Control-Max-Age header for CORS requests to the OAuth client registration endpoint.",
		transports: ["sse", "streamable-http"],
		distribution: ["js", "oci"],
		type: "number",
		choices: [],
	...
	{
		env: "DOCSPACE_SERVER_RATE_LIMITS_OAUTH_METADATA_CAPACITY",
		header: "",
		title: "Server Rate Limits OAuth Metadata Capacity",
		description: "The maximum number of requests allowed per window for the OAuth metadata endpoints.",
		transports: ["sse", "streamable-http"],
		distribution: ["js", "oci"],
		type: "number",
		choices: [],
	...
	{
		env: "DOCSPACE_SERVER_RATE_LIMITS_OAUTH_METADATA_WINDOW",
		header: "",
		title: "Server Rate Limits OAuth Metadata Window",
		description: "The time window in milliseconds for the rate limit for the OAuth metadata endpoints.",
		transports: ["sse", "streamable-http"],
		distribution: ["js", "oci"],
		type: "number",
		choices: [],
